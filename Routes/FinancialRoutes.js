...
const { addFinancialDetail, getFinancialDetails, deleteById , updateFinancialDetail } = require("../Controllers/FinancialContoller");
...
router.put("/update_financial/:id", upload.single("file"), updateFinancialDetail);
